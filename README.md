...
+-------------------------------------------------------+
     ...
     +--------------|------------------------|---------------+
                    |                        |
                    | C# Method Calls        | C# Method Calls
                    v                        v
     +-------------------------------------------------------+
     |                 Business Logic Layer                  |
     |                                                       |
     |  +--------------------------+  +-------------------+  |
     |  | DocumentIngestionService |  |  RagChatService   |  |
     |  |      (iTextSharp)        |  | (Semantic Kernel) |  |
     |  +------------|-------------+  +--------|----------+  |
     |               |                         |             |
     |               +------------+------------+             |
     |                            |                          |
     ...
     |                           | |                           |
     | +-----------------------+ | | +-----------------------+ |
     | |     OllamaClient      | | | |     QdrantService     | |
     | |   (Semantic Kernel)   | | | |    (Qdrant.Client)    | |
     | +-----------|-----------+ | | +-----------|-----------+ |
     +-------------|-------------+ +-------------|-------------+
                   |                             |
                   | HTTP (Port 11434)           | gRPC (Port 6334)
                   v                             v
     +---------------------------+ +---------------------------+
     |  Infrastructure (Local)   | |   Infrastructure (Docker) |
     |                           | |                           |
     |  +---------------------+  | |  +---------------------+  |
     |  |    Ollama Server    |  | |  |      Qdrant DB      |  |
     |  | - llama3.2          |  | |  | (Persistent Storage)|  |
     |  | - nomic-embed-text  |  | |  +---------------------+  |
     |  +---------------------+  | +---------------------------+
     +---------------------------+
